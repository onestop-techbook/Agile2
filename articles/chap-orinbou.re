...
見様見真似で始めたこともあり、序盤はバックログの粒度もかなり混沌としていました。POや営業や広報は、ビジネス価値が関心事の中心です。一方で、開発者は、ビジネス価値を生み出すために必要な具体的な作業が関心事の中心になります。このように、観点や粒度が異なるバックログが混在し、かつ、膨大な数になっていったことで、徐々に管理が煩雑になっていきました。その結果、作業状況の確認やフォローも難しくなり、デイリースクラムの時間もどんどん長くなっていきました。そこで、バックログを次のように明確に区別して管理することにしました。
...
地道な改善を継続的にコツコツと続けて、その効果が実感できるようになってくると、チームメンバーの意識も少しずつ変わっていきました。自称「過去をふりかえらない男」を明言していた若手開発者が、ある時ふいに @<strong>{「環境って自分たちで変えられるものなんですね。僕、知りませんでした」} といってくれました。
...
変革を推し進めるためにはリーダー（先達）が必要だということは、誰しも認めるところだと思います。しかし、リーダー独りだけでは物事はなかなか思ったようには進みません。変革の取り組みを支持してくれる最初の協力者（以下、「ファーストフォロワー」と呼ぶ）がたった一人居てくれるだけで、新しい取り組みに対する推進力がまったく違ってきます。さらに2人なら、失敗も最高の「ふりかえり」のネタ（むしろ宝物）として前向きにとらえることができるようになり、一人では躊躇して（人知れず）諦めてしまうようなケースも激減します。
...
客先に常駐して、顧客側のエンジニアと自社エンジニアで混成チームを組んでGIS系アプリケーションを開発する現場でした。開発の人手が足りないということで、私は3ヵ月の期間限定の助っ人としてプロジェクトへ送り込まれたはずなのですが、なぜか2年以上そこで過ごすことになりました。その現場で取り組んだエピソードを少しだけご紹介します。
...
日本におけるアジャイル開発の第一人者の平鍋健児氏も、かつて「アジャイルなんて今の仕事で使えないじゃん！」といわれる境遇に陥ったことがあるそうです。そんな時「今の仕事を今よりも良くすることはできる」という言葉に救われ、アジャイルに拘り過ぎることをやめ、アジャイルの要素を使って「いきいきとした仕事がしたい」「お客さんと喜び合える仕事がしたい」という気持ちに切り替えて改善や工夫を続けたそうです。私もその言葉には何度も救われてきました。このエピソードはAgile Japan 2016の基調講演で語られていますので、よかったら次の記事も読んでみてください（筆者が過去に執筆した記事です）。
