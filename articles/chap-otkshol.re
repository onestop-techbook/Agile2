...
初めての案件実施時には、疑問に思ったことをSlackに書き込むと、答えられる人に回答をすぐもらったり、必要に応じて通話をつないでサクッと解決したり、しかもその動きをチーム全員で補い合っており、「なんて良いチームに来たんだ！」と感じていました。

しかし、上司は「メンバーの大量入れ替えに伴い、チームの文化とスタンス部分を心配している」といっていました。チームに特に問題を感じていない自分は、その言葉の真意を理解することができませんでした。なお、〓表14.1〓は、筆者の開発チームでの開発イベントの呼び方を、一般的なスクラムイベントの呼び方に対応させた表です。呼び方そのものは本質的なものではないかもしれませんが、その目的が必ずしも共有、一致していなかったのかもしれません。
...
ある日、いつも通り開催されている朝会に上司がふらっとやってきて、一通り終わったあとに「朝会ってなんでやっているんだっけ？もしかしたらもう少し短くできるかも」と筆者とチームリーダーに質問しました。しかし、筆者もチームリーダーも、その質問に明確に答えることはできませんでした。

この質問に答えられないということは、毎日行われている朝会は実施されているが、何のために行っているのか誰も分からない恐ろしい状況であることを、このタイミングで初めて認識しました。

朝会は日々の作業内容を報告すれば良いのかなとぼんやり思っていましたが、進捗状況を共有する理由、朝会では話すべき話題など、会議体として重要な項目が明確でないまま運用されている現状がそこにはありました。

目的や内容がはっきりしてしいないので、作業進捗共有の流れから話題がそれて議論が発散してしまい、朝会そのものに時間がかかってしまうことも多々ありました。朝会は開発メンバー全員が出席しており、かなり多くの工数をさいています。筆者には、本当にかけた工数の価値がある時間になっているか、自信を持ってYESと答えることができませんでした。

== インセプションデッキとの出会い
このままでは良くないことは理解できましたが、どうやって現状を打破できるか途方に暮れていました。そんな自分に対して、上司は「インセプションデッキ的な何かをチームで取り組んだほうがよいかもね」という助言をくれました。その助言を聞いた自分は「なるほど、わからん」状態でしたので、その言葉の意味を調べ、書籍「アジャイルサムライ-達人開発者への道」（オーム社、2011）にたどり着きました。
...
個人的な収穫もありました。「我々はなぜここにいるのか」を議論するとき、やったことのないファシリテーション役に挑戦してみましたが、意外とやってみれば何とかなることを学びました。同時に、悩んでいる様子や喜んでいる様子が表に出過ぎる性質があるので、ファシリテーションをするときは議論の進める邪魔にならない程度に、もう少し感情コントロールができるとより良いという課題も自覚することができました。普段の業務でファシリテーションスキルと向き合う機会があまりなかったので、貴重な経験になりました。
...
現在は、いつの間にか目的が明確でなくなってしまっていた定例イベントの目的を開発チームふりかえりの時間を使って少しずつ見直しを進めています。今まで当たり前のように過ごしていたイベントの目的をあらためて考えるので、そう簡単に議論が進まないのが正直なところです。
...
== まとめ
今回のできごとで初めてアジャイル開発と向き合い、目の前のチームに必要なものは何かを考え、もがきながら実践する貴重な経験をすることができました。次は自分が文化を吹き込んで開発チームのアウトカムを最大化させて、プロダクトを使っている方々、チームメイトの役に立てるようになりたいです。

もし、自分と同じようになんとなく朝会など定期イベントは実施しているけど「何でやっている？」という質問に答えられない、あるいはチームメンバーで回答バラバラな状況であれば、まずはインセプションデッキの「我々はなぜここにいるのか」だけでも時間をかけて考えることをおすすめします。チームの拠り所ができて、以降の議論がスムーズになると思います。
