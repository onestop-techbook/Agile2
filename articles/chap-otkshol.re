...
しかし、上司は「メンバーの大量入れ替えに伴い、チームの文化とスタンス部分を心配している」といっていました。チームに特に問題を感じていない自分は、その言葉の真意を理解することができませんでした。なお、表14.1は、筆者の開発チームでの開発イベントの呼び方を、一般的なスクラムイベントの呼び方に対応させた表です。呼び方そのものは本質的なものではないかもしれませんが、その目的が必ずしも共有、一致していなかったのかもしれません。
...
== インセプションデッキとの出会い
このままでは良くないことは理解できましたが、どうやって現状を打破できるか途方に暮れていました。そんな自分に対して、上司は「インセプションデッキ的な何かをチームで取り組んだ方が良いかもね」という助言をくれました。その助言を聞いた自分は「なるほど、わからん」状態でしたので、その言葉の意味を調べ、書籍「アジャイルサムライ-達人開発者への道」（オーム社、2011）にたどり着きました。
...
現在は、いつの間にか目的が明確でなくなってしまっていた定例イベントの目的を開発チーム振り返りの時間を使って少しずつ見直しを進めています。今まで当たり前のように過ごしていたイベントの目的をあらためて考えるので、そう簡単に議論が進まないのが正直なところです。
