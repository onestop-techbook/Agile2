...
目的や内容がはっきりしてしいないので、作業進捗共有の流れから話題が逸れて議論が発散してしまい、朝会そのものに時間がかかってしまうことも多々ありました。朝会は開発メンバー全員が出席しており、かなり多くの工数を割いています。筆者には、本当にかけた工数の価値がある時間になっているか、自信を持ってYESと答えることができませんでした。
...
しかし、今の我々には立ち返るチーム目標があるので、議論が発散しそうになったり、判断に迷った時はチーム目標に立ち返り、着実に議論を進めることができるようになりました。これは大きな一歩なのではないかと思います。

チーム全員が定例開発イベントの目的がいえること、その目的がメンバー間で相違がないこと、必要に応じて柔軟にアップデートできることを目指して今日もカイゼンに取り組んで参ります。

== まとめ
今回の出来事で初めてアジャイル開発と向き合い、目の前のチームに必要なものは何かを考え、もがきながら実践する貴重な経験をすることができました。次は自分が文化を吹き込んで開発チームのアウトカムを最大化させて、プロダクトを使っている方々、チームメイトの役に立てるようになりたいです。
