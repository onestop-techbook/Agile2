...
〓本節〓では、朝会などの定期的に開催されている開発イベントの目的を答えることができなかったことをきっかけに、アジャイル開発とはじめて向き合った話を共有します。

インセプションデッキという言葉も知らなかった状態から、チームに必要なことを考え、カイゼンをスタートさせることができました。
筆者と同じようにアジャイルにはじめて向き合い、はじめて悩んでいる方にとって、何かの参考になれば幸いです。
...
はじめての案件実施時には、疑問に思ったことをSlackに書き込むと、答えられる人に回答をすぐもらったり、必要に応じて通話をつないでサクッと解決したり、しかもその動きをチーム全員で補い合っており、「なんてよいチームに来たんだ！」と感じていました。
...
この質問に答えられないということは、毎日行われている朝会が、実施されてはいるがなんのために行っているのか誰もわからない恐ろしい状況であるということです。それをこのタイミングではじめて認識しました。
...
インセプションデッキ@<fn>{inceptiondeck}とは、10個の質問から構成される、プロジェクト開始前に認識をあわせておきたい内容です。5つの「Why」と5つの「How」の合計10個の質問から構成されます。主にプロジェクトチーム発足時に使用されるものですが、多くのチームメンバーが入れ替わったチームにも適用可能だと思いました。

しかし、10個の質問すべてに取り組もうとすると膨大な時間がかかり、今のチームには必ずしも取り組む必要がない質問もあると感じました。そこで、チームリーダーともインセプションデッキの実施とその内容を議論を行いました。その結果、開発チームのキックオフを対面開催し、そのなかでインセプションデッキの1つである「我々はなぜここにいるのか？」に取り組むことを決めました。
...
そして、はじめて対面したチームメンバーとお昼においしいラーメンを一緒に食べた絆も手に入れることができました（嬉しすぎて卵をためらうことなくトッピングして、いつもより豪華にしました）。
...
== まとめ
今回のできごとで、はじめてアジャイル開発と向き合い、目の前のチームに必要なものは何かを考え、もがきながら実践する貴重な経験をすることができました。次は文化を吹き込む側となって、開発チームのアウトカムを最大化させ、プロダクトを使っている方々やチームメイトの役に立てるようになりたいです。
