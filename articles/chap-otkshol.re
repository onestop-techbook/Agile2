...
しかし、上司は「メンバーの大量入れ替えに伴い、チームの文化とスタンス部分を心配している」と言っていました。チームに特に問題を感じていない自分は、その言葉の真意を理解することができませんでした。なお、表14.1は、筆者の開発チームでの開発イベントの呼び方を、一般的なスクラムイベントの呼び方に対応させた表です。呼び方そのものは本質的なものではないかもしれませんが、その目的が必ずしも共有、一致していなかったのかもしれません。
...
現在は、いつの間にか目的が明確でなくなってしまっていた定例イベントの目的を開発チーム振り返りの時間を使って少しずつ見直しを進めています。今まで当たり前のように過ごしていたイベントの目的を改めて考えるので、そう簡単に議論が進まないのが正直なところです。
