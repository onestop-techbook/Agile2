...
アジャイルが経験主義の立場を採る理由は、人間には未来を正確に予知する能力はない、ゆえに未来は不確実だ、と考えているからです。ましてや計画に実績を一致させようとする試みは、天気予報に合うように今日の天気を変えろといっているようなもので、非合理としかいいようがないというわけです。なので、経験主義においては、実績が計画と乖離することは別に大した問題ではありません。乖離したなら、次からは計画のほうを適応させれば良いからです。もう一度書きますが、予実が乖離するときは、計画のほうが間違っていたのです。

== 計画主義による計画の立て方
たとえばスクラムにおいて、スプリントプランニングで今から取り組むスプリントバックログのスコープを決定する場合を例にとって、計画主義と経験主義の違いを図にしてみましょう。

たとえばスクラムでスプリントプランニングを行うとして、もし、計画主義の考え方でスプリントのスコープを計画するとしたら、〓図番号〓のようになるでしょう。
