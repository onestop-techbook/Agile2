...
アジャイルが経験主義の立場を採る理由は、人間には未来を正確に予知する能力はない、ゆえに未来は不確実だ、と考えているからです。ましてや計画に実績を一致させようとする試みは、天気予報に合うように今日の天気を変えろといっているようなもので、非合理としかいいようがないというわけです。なので、経験主義においては、実績が計画と乖離することは別に大した問題ではありません。乖離したなら、次からは計画の方を適応させれば良いからです。もう一度書きますが、予実が乖離するときは、計画の方が間違っていたのです。
