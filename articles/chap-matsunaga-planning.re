...
一般的にアジャイルでは「予実管理」をしません。予実管理というのは、ものごとが計画（予定）通りに行ったかどうかを管理するという考え方ですが、アジャイルで予実管理をしないのは、ものごとが計画通りにいかない理由は、計画がまちがっていたからに決まっていると考えるからです。

計画に実績を合わせるのは従来型の計画主義の考え方です。一方アジャイルは経験主義なので、過去の実績に合わせて計画を立てます。

みなさんはどちらが正しいと思いますか？あるいはどちらが好きですか？

アジャイルが経験主義の立場を採る理由は、人間には未来を正確に予知する能力はない、ゆえに未来は不確実だ、と考えているからです。ましてや計画に実績を一致させようとする試みは、天気予報に合うように今日の天気を変えろといっているようなもので、非合理としかいいようがないというわけです。なので、経験主義においては、実績が計画と乖離することは別に大した問題ではありません。乖離したなら、次からは計画のほうを適応させれば良いからです。もう一度書きますが、予実が乖離するときは、計画のほうがまちがっていたのです。
...
計画主義では計画が正しいと考えるので、1スプリントで55ポイントやると決めたら、チームはその計画を達成できるように仕事を進めていくことになります。最初は計画通りに行かなくても、徐々に改善して計画を達成出来るようにするわけです。計画主義に慣れている方はこの考え方になんの違和感も抱かないんじゃないかと思います。

//image[image1][計画主義による計画の立て方][scale=1.0]


しかし、前述の例だとスプリントを重ねるごとに徐々に改善はしているものの、まだ一度も計画を達成した（予定通りに進んだ）ことがなく、このまま未達が続けばそろそろステークホルダーからのプレッシャーがかかってきそうです。チームはそのうちプレッシャーに負けて、見積もりそのものを不正に操作して（大きめに見積もる）、計画を達成したように見せかけるようになるかもしれません。
...
まず、Sprint nでは、チームは55ポイントと計画しましたが、実際には40ポイントしか達成できませんでした。なので、次のスプリントでは、過去の実績に基づいて40ポイントと計画します。このとき何かしらの改善施策は入れておくようにします。そうしてこのスプリントでは、改善施策が功を奏して、チームは計画を超える42ポイントを達成しました。なので次のスプリントでは42ポイントと計画します。これを繰り返して、常に実績に合わせて計画を立てるようにしていきます@<fn>{planning}。
...
== 見積もりの精度が上がらない？
最後に、計画に不可欠な「見積もり」についてです。計画主義の考え方では、計画をより確かなものにするため、見積もりの精度を上げようとします。つまり見積もりと実績とを比較して、その差がなるべくゼロに近づくような取り組みをするわけです。が、これも実際にはあまり意味が無いのでやめたほうが良いでしょう。理由は前述のとおり、人間には未来を正確に予知する能力は無いからです。

相対見積もりを採用している場合はさらに意味がありません。なぜなら、相対見積もりは大きさの比であり、例えば工数÷工数、あるいは時間÷時間などといった計算をすることになるので、見積もられた数値は無次元数（単位が無い）になるからです。単位のないものは測定できないため、予実の比較ができず、従って精度の計算もできません。「相対見積もりが難しい」「どうしても時間見積もりになってしまう」といっているチームは、この罠にハマっていることが多いようです。
