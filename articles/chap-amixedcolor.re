...
スクラムは、チームが価値を生み出すための軽量級フレームワークのこと。アジャイルと同様に価値基準が存在し、スクラムの理論に基づいています。アジャイルであるためによく採用されるフレームワークです。アジャイルマニフェストのようにスクラムガイドというガイドがあり、初版から数年おきに更新を繰り返しています。ガイドだけでなく、研修・認定資格・多数の本が世に出ています。
