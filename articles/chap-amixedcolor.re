...
この章では、アジャイルの実践として、アジャイルであるために用いられるいくつかのフレームワークや手法を解説します。決してこれらがアジャイルにおけるすべてではありませんが、アジャイルを実践するうえで活用できるツールをイメージする助けになることを目的としています。また、陥りやすいポイントや重要なポイントを必要に応じて補足し、本書で得たキーワードをもとに実践できる姿勢を整えます。第一歩というよりは、歩きはじめる前に「よーいドン」の「よーい」をしてもらえるように執筆してます。
...
リーンキャンバスについて短く語ることは困難ですが、はじめて使用するときはぜひ枠を埋める順番に注意してください。枠が多いためどこから埋めたらよいかわからないといった疑問に対して、本書で書かれている方法を用いることで埋めやすくなるでしょう。
...
3つ目の作成物、インクリメントとは、1つのPBIのタスクがすべてDONEになり、POによって受け入れられたあとのPBIのことです。プロダクトの改善における踏み石とも呼ばれ、この踏み石をひとつひとつ増やし、ふんでいくことで、プロダクトがより価値を生むことが期待されます。
...
望ましくないパターンが2つあります。それは、①PBIのいくつかを先に選択することが決まっていて、それをまとめたようなスプリントゴールになること、②スプリントプランニングの時間を超過して、計画する時間を延長してしまうことです。①については、PBIがPBLのなかで適切な順序に並んでいることを前提としてしまっていて、本来はそうではなく、前回のスプリントのふりかえりもふまえたうえで、「今この瞬間、次のスプリントでは何を達成すべきなのか」というものをゴールとして設定することが望ましいです。②については、計画が時間内に終わらないのであれば、そもそもPBIがReadyに状態になっていないことや、あまりにも不確実性が高く計画しきれないため、早く動いたほうがよい状況であることがあります。
...
ぜひ、本書のキーワードをもとに「よーいドン」の「よーい」をして、「ドン」といつでも一歩目をふみ出せるようにしてみてください。アジャイルを実践する者として、ともに歩む日を楽しみにしております。
