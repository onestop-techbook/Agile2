...
なお、手段ありきで考えないうえで、「ユーザーは何をしたいのか」が解決方法ではなく動機であることに気をつける必要があります。困りごととその解決策への先入観のある状態から少し離れて、ユーザーが特定の場面で何がしたいのか、何ができるからそれをしたいのかと、具体的かつ客観的にユーザーのニーズを見極めます。

//image[the-job-story-format][The Job Story Format][scale=0.8]

=== リーンキャンバス

リーンキャンバスとは、フォーマットに沿ってアイデアを書き出しながら、そのアイデアを検証するというものです。フォーマットについての説明でいろいろな表現をされることがありますが、どういった説明もアイデアを検証するうえで重要な観点をおさえていることは共通しています。すでに何かしらのアイデアがある前提で、そのアイデアをブラッシュアップしていくことに用いられます。それぞれの枠には必ずしも1つの回答だけを書く必要はありません。複数書いたり長文を書いたりもしつつ、それを集約したり削ったり、具体的にしたり抽象的にしたりして、簡潔に要点を記載していきます。それらの過程で、アイデアが大きく転換する可能性もあります。
...
具体的なやり方の一例は、次のとおりです。
 ...
 1. 人数にもとづいてブレインライティングの表の行数を決める（基本的には人数+1行）
 2. 人数分のブレインライティングをする表形式の枠を用意する（3人であれば同じ形式の表を3つ）
 3. テーマを決める（〇〇したい・〇〇を解決したい）
 4. 順番に表を回しながら、1ターン1分の中で、1行の3つ分、その表に存在しないアイデアを出す

存在しないアイデアを出すうえで、まったく新しいアイデアを出してもよいですし、すでに〓その表〓にあるアイデアを少し捻ったりして書いても問題ありません。限られた時間の中で、突拍子もなくても脈絡もなくても、とにかく枠を埋め切ることが大切です。
...
//noindent
これらをつなぐと、「①を望む②向けの③は④です。これは⑤ができ、⑥とはちがって⑦があります」という文章になります。あなたのアイデアをもとに作ってみたり、手元にあるもの（例えば、今持っているガジェットなど）を紹介するエレベーターピッチを作ってみるといったかたちで練習することもできます。
