...
フォーマットを調べると、表現にブレがあり一見するとどのフォーマットが良いかわかりにくいですが、一貫して次の7つを含むことが多いです。それは、①顧客の望むニーズや課題・②対象顧客・③プロジェクトやプロダクトの名称・④カテゴリやジャンル・⑤重要な利点と対価を払う説得力のある理由・⑥競合・⑦競合との違い、の7つです。それらをつなぐと、次のような文章になります。「①を望む②向けの③は、④です。これは⑤ができ、⑥とは違って⑦があります。」という文章です。
