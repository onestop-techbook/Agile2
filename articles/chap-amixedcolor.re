...
〓この章〓では、アジャイルの実践として、アジャイルであるために用いられるいくつかのフレームワークや手法を解説します。決してこれらがアジャイルにおけるすべてではありませんが、アジャイルを実践するうえで各手法が活用されるイメージの助けとなることを目的としています。また、陥りやすいポイントや重要なポイントを必要に応じて補足し、本書で得たキーワードをもとに実践できる姿勢を整えます。第一歩というよりは、歩きはじめる前に「よーいドン」の「よーい」をしてもらえるように執筆してます。
