...
この章では、アジャイルの実践として、アジャイルであるために用いられる代表的なフレームワークや手法を説明します。決してこれらがアジャイルにおける全てではありませんが、アジャイルを実践する上でそれをイメージする助けになることを目的としています。また、陥りやすいポイントや重要なポイントにおいて必要に応じて補足し、本書で得たキーワードをもとに実践できる姿勢を整えます。第一歩というよりは、歩き始める前に「よーいドン」の「よーい」をしていただけるように執筆しております。
...
本書では、スクラムにおける2つ、作成物とイベントについてのみ触れます。スクラムの理論・価値基準・スクラムチームについてはほとんど触れておりません。アジャイルの実践として、3-1・3-2で扱ったように、実戦における具体的なことを中心に扱います。
