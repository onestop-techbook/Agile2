...
この章では、アジャイルの実践として、アジャイルであるために用いられるいくつかのフレームワークや手法を解説します。決してこれらがアジャイルにおけるすべてではありませんが、アジャイルを実践するうえで活用できるツールをイメージする助けになることを目的としています。また、陥りやすいポイントや重要なポイントにおいて必要に応じて補足し、本書で得たキーワードをもとに実践できる姿勢を整えます。第一歩というよりは、歩き始める前に「よーいドン」の「よーい」をしていただけるように執筆しております。
...
とはいえ、特に2つ目にあるように、手段ありきで考えてしまいやすいことが多いです。そんなときに便利な、The Job Story Formatというものがあります。まずはカスタマージャーニーマップを一通り書いてから、困っていそうなポイントを複数あげます。そして、それぞれのポイントにおいて、次のような観点でポイントを展開して書くことで、ユーザーが達成したい仕事を明確にします。
...
//noindent
これらをつなぐと、次のような文章になります。「①を望む②向けの③は、④です。これは⑤ができ、⑥とはちがって⑦があります。」という文章です。あなたのアイデアをもとに作ってみたり、手元にあるもの（例えば今持っている
...
本書の冒頭で触れたように、アジャイルとはやり方ではなくあり方です。この章では、そのあり方を実践するための方法について紹介してきました。再三になりますが、決してこれらの方法だけがすべてでなければ、紹介した方法そのものも記載した解説だけにとどまりません。しかしながらこれらは、アジャイルの実践として鍵となることの多い方法です。特に、最後に紹介したスクラムは、プロダクト開発をアジャイルに行ううえで非常に有用なフレームワークです。

もし読んでみてわからない単語や解説が多ければ、各節のタイトルになっているフレームワークの名前を覚えておき、アジャイルについて経験し学びを進めていく中で、その節の名前が出てきたときに立ち返ってみてください。何が重要だと書かれていたのかをあらためて読み、実践につなげることができるでしょう。そうではなく、なんとなく理解して読み進めることができたり、すでに実践していることがあれば、自分が想像していたものと何かちがうところはないか、実践している中で書かれているものとちがうところはないか、自分の理解と異なるところを意識して読んでみてください。この解説があなたの状況に必ずフィットするわけではありませんが、筆者の考えるポイントや概要と異なるところがあれば、その点について一考し、改善できる余地があるかもしれません。
