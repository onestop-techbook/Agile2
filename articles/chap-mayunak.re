...
逆に、アジャイルな計画づくりがうまくいくためには、この不確実性を受け入れることが大切な第一歩となります。前出の「アジャイルな見積りと計画づくり〜価値あるソフトウェアを育てる概念と技法〜」では、最後の章で架空のチームが登場し、様々な課題に直面しながら計画を修正していく様子が描かれています。その様子を見ていると、チームがプロダクトについてだけでなく、自分たちについても少しずつ学び、チームワークの質を上げていく様子を見ることができます。
...
それでは、不安とうまく付き合いつつ、前に進むにはどうすればいいのでしょうか？全ての不安を取り除くのは難しいかもしれませんが、筆者が体験した過去の取り組みでうまくいった例をいくつかあげてみます。
