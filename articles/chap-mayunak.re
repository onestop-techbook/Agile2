...
「アジャイルな見積りと計画づくり〜価値あるソフトウェアを育てる概念と技法〜」という本のなかでMike Cohn氏は、従来の計画方法が崩れがちな理由の一つに「不確実性を無視している」ことをあげています。
...
鍵となるのは、いかに素早くプロダクトチームとして成長し、お互いのリズムを掴むか。初めのうちに疑問点や不協和音を見ないフリをしてしまうと、あとあと自分たちに戻ってくることになります。つまり不安になることが起こった場合、多少時間がかかったとしても未来の自分たちを助けるつもりで対処する方がいいのです。
