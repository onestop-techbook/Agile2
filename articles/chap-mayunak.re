...
職場で初めてアジャイルが導入された際、私も同僚もかなり苦戦をしました。うまくいっていなかった原因は様々でしたが、当時、クライアントを含めチーム全体を覆いがちだったネガティブな雰囲気をよく覚えています。それは「不安」、そしてそれが解消されないことによる「不満」でした。
...
「アジャイルな見積りと計画づくり」という本のなかでマイク・コーン氏は、従来の計画方法が崩れがちな理由の一つに「不確実性を無視している」ことをあげています。
...
//quote{
「同様に、私たちはプロダクトを構築する方法に関する不確実性も無視している。どんな作業なのかはっきりわかっていないのに、たとえば「10日間」などと、高い精度で見積もれるという前提に立っているのだ。」
//}


プロジェクトの初期段階におけるプロダクトの不確実性は意識したことがあると思います。ですが、「プロダクトを構築する方法に関する不確実性」は、むしろ見て見ぬふりをしたくなる部分かもしれません。どのくらいかかるか、どうアプローチするのか、正確にはわからないと口に出してしまうと、まるでチームの知識や専門性が足りていないように感じてしまうからです。ですが、プロダクトに不確実性がある以上、それを構築する方法にも少なからず不確実性がある事は避けられません。また、プロダクト開発がチームスポーツであること、私たちが人間であるということも、不確実性を上げる要素です。特に、新しくできたばかりのチームでは、お互いにペースを掴むまでの試行錯誤も不確実性の要素になるでしょう。


逆に、アジャイルな計画づくりがうまくいくためには、この不確実性を受け入れることが大切な第一歩となります。「アジャイルな見積りと計画づくり」では、最後の章で架空のチームが登場し、様々な課題に冷静に対応しながら計画を修正していく様子が描かれています。その様子を見ていると、チームがプロダクトについてだけでなく、自分たちについても少しずつ学び、チームワークの質を上げていく様子を見ることができます。


このチームのように、アジャイルでは早い段階でプロダクトとプロダクト構築の方法、両方に関して「うまくいっていないこと」を可視化させ、対処することでリスクを減らしていくことが大切です。しかし、実際には不確実性が多い中で問題が噴出すると、人は不安になるものです。
...
もちろんリリース用の開発が始まる前に「ディスカバリー」を行い、ある程度コンセプト作りをしているケースがあるかもしれません。しかし、おおまかな方向性が定まっていたとしても、デザインという作業は発散と収束を繰り返します。しかも一度ではなく、視点を変えながら何度もその過程を繰り返すことで最終的なソリューションに落ち着きます。つまり、発散させている間は常に「何が正しいのかわからない」という状態が続くのです。


もちろん開発も模索、検討する時期があるとは思いますが、最短で最適解を目指すでしょう。相対的な差ではありますが、お互い、その時々のベクトルが違うことが意識できていないと、次第に不満が出てきます。デザイナーは十分な時間がないと感じたまま、開発者を待たせているプレッシャーに悩み、開発はなかなかソリューションが決まらないことに苛立ちを覚えます。

== 不安感とうまく付き合うには


こう聞くと「ならばデザインと開発は別に作業した方がいいのでは？」と思うかもしれません。しかし、その場合「技術的に実現できないデザインをしてしまう」「開発段階でデザインが改変され、元の重要な意図が抜けてしまう」などのリスクを後回しにすることになります。もちろんプロジェクトに余裕があれば「出戻り」が起こりデザイナーが修正することになりますが、最悪の場合、重要な要素が抜けたことに気付かずそのままリリースされることになります。一見非効率に見える、デザインと開発が一体になったアジャイルは、長い目でみれば効率とプロダクトの質を両立する最適解です。


鍵となるのは、いかに素早くプロダクトチームとして成長し、お互いのリズムを掴むか。初めのうちに疑問点や不協和音を見ないフリをしてしまうと、後々自分たちに戻ってくることになります。つまり不安になることが起こった場合、多少時間がかかったとしても未来の自分たちを助けるつもりで対処する方がいいのです。


それでは、不安とうまく付き合いつつ、前に進むにはどうすればいいのでしょうか？全ての不安を取り除くのは難しいかもしれませんが、筆者が体験した過去の取り組みでうまくいった例をいくつか挙げてみます。
 ...
 * 多少ドキュメンテーションが後回しになっても、コミュニケーションを取りお互いの理解を深めることを優先する。ドキュメンテーションは合意したことの記録程度にとどめる。
