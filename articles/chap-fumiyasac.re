...
私自身はモバイルアプリ開発の中でも、特にUI実装に関連する分野が特に関心が高いです。この点については、20代のときにデザイナーとしてのキャリアを歩んだことも関係していると思います。故にモバイルアプリ開発において、UI実装の観点から見る難易度の見積もりは、プロジェクトの成功に直結する重要な要素であると考えています。
...
プロダクトマネージャー・デザイナー・エンジニア・QA等、各役割が1つのチームとして協力することが不可欠になります。特にUI実装と機能ロジックは切り離して考えることが難しい場合も珍しくないため、役割や職種を越えて共通理解を持っている状態が望ましいと思います。
