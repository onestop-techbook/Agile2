...
本章では、筆者が実際に取り組んで効果のあった関係性向上の手法を、チーム内およびチーム外の2つの視点から紹介します。すべての組織に適用できるわけではありませんので、各組織の状況に応じて判断していただければと思います。

== チーム内のよい関係性の作り方
次はチーム内の関係性を改善するために実施した取り組みです。

==== やってよかったこと1：スクラムの勉強会を定期開催する
チーム立ち上げ直後に、1スプリントに1時間くらいかけてスクラムについての勉強会を実施しました。
 ...
 * 内容：
 ** 筆者のチームでは、立ち上げ時こそユーザストーリーマッピングをみんなで検討したのですが、それ以降はなんとなくPOがユーザストーリーを考える人、開発者が開発する人というように、役割が決められてしまいました。その結果徐々にPOと開発者の関係が遠くなっていくのを感じたので、POにはPBIの完成度の低い（エピック単位までしか検討していない）状態でリファインメントに挑んでもらうことにしました。
 ...
 * 効果：
 ** ステークホルダーそれぞれの興味ある内容が明確になり、誰と何を調整すればよいかがわかります。
 ...
 * 内容：
 ** ステークホルダーの中にはアジャイル開発に懐疑的な方やネガティブな感情を持つ方もいます。共創アジャイルの場合、筆者の会社の開発力にも懸念を持つ方もいます。この状態で序盤に開発が躓くと、ネガティブな印象を持たれやすくなります。
 ...
 * 内容：
 ** 「やってよかったこと10 スタートダッシュを成功させる」と反対の話になりますが、うまくいっていない状態も積極的に共有することでステークホルダーに味方になってもらい関係性をよくすることができます。
