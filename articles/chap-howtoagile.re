...
なぜこれらのプロジェクト管理手法がソフトウェア開発の管理手法として適した手法であると考えられたのでしょう。建設分野・製造分野（特にオーダーメイド品生産）の開発管理手法は「毎回異なるものを作り、前と丸々同じものを作ることはほぼ無い」という点でソフトウェア開発手法と非常に近しかったためです。当時現役のITエンジニアだった諸先輩にこの頃の話を伺った際にも、「開発管理手法が確立していなかった当時のソフトウェア開発（およびそのプロジェクト管理手法）からすると非常に革新的だった」と伺っています。
...
しかし、これらの開発手法は概ね「開発者は顧客が要求することを最初からすべて理解している」「開発者は顧客にこの先要求されることを最初からすべて予測している」といった@<b>{前提が成立すればうまくいく}、@<b>{これからの変化にも耐えられる}という点に基づいており、「最終の完成形のソフトウェアを作りきればその後は弄らない（弄りたくない）」という認識に立ちます。言い換えれば、@<b>{仕様書が過不足なく完璧に作られている}、といった、現実的には不可能なことが必要条件となっています。しかし、未来は予測できない不確実なものです。

また、これらの従来型の開発手法でも一応、状況の変化などは考慮しています。ただし、その考え方は、「状況の合わない部分が出ることはあって、その際に小規模な改修はするが、基本は大きく合わなくなれば丸ごと作り直せば良い」という考えに立つものです。

しかしながら、実際は、1998年に出た本でも
『伝統的な「ウォーターフォール」のアプローチで開発を行うことは、今日のシステムではもはや柔軟でもふさわしくもない。』@<fn>{piason1}
と記載されています。ここまであげた各種の開発手法が、「（特に、未来の）変化に耐えられる」か？という観点では大きな課題を持っているという事実は、当時のソフトウェア開発手法の共通の課題であった事が伺えます。
...
//footnote[xpbook][以下、XP本と記載します。邦訳の第2版は、現在も普通に購入可能です。 https://www.ohmsha.co.jp/book/9784274217623/　また、上で記載したXPが初めて実践されたプロジェクトについての話も12章「はじまりの物語」に記載があります。]
...
XPが話題になった当時、筆者は大手のSIerでシステム開発に従事していました。XPが話題になった時に、「言ってることはわかるけど社内でコレ適用できんの？」という話題で盛り上がった事を今でも鮮明に覚えています。
...
簡単に言うと、ノーコードツールを現場で継続的に改善しながら業務にフィットさせて使っていくためのコツやノウハウ、考え方をパターンとしてまとめ、共有知としたものです。kintoneでの開発・運用は前述のようなかたちを目指すため、アジャイル開発になります。
