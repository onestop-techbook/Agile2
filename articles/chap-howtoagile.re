...
例えば、プロジェクトマネジメントの知識体系ガイドである「プロジェクトマネジメント知識体系ガイド（PMBOK(R)ガイド）」@<fn>{pmbok}を見てみると、2017年に発行された第6版で「アジャイル」の内容がはじめて本文に組み込まれました。さらに、2021年に発行された第7版では、「価値を提供する」ことに重きを置いた、アジャイル的なプロジェクトマネジメントを行うための知識体系へと大きく変貌を遂げました。
...
//footnote[xpbook][以下、XP本と記載します。邦訳の第2版は、現在も購入可能です（https://www.ohmsha.co.jp/book/9784274217623/）。また、前述したXPがはじめて実践されたプロジェクトについての話も、第17章「はじまりの物語」に記載があります。]
...
2002年8月号からエクストリームプログラミングについての記載が出はじめ、
...
2005年08月号の特集記事「緊急レポート！ 最新ソフトウェア開発手法事情」のなかで、「4章　繰り返し型開発の落とし穴―失敗から学ぶ効果的運」が最初でした。とはいえ、あまりガッツリした内容ではありませんでした。
...
前述の契機となった話のあと、Jeff Sutherlandはこれらを整理・構築し、2011年に「スクラムガイド」@<fn>{scrumguide}をまとめあげます。
