...
海外の歴史は「スクラム」→「XP」の順でしたが、日本で広まっていった順序的には実は逆で、「XP」がまず有名になり、その後「スクラム」が浸透していった　という歴史があります。

XPについては、2001年頃から情報処理学会の刊行物(会誌、論文誌)で情報が出始め、2002年3月、4月の会誌でXPについてのまとまった記事が掲載されたことが契機のようです。
https://ipsj.ixsq.nii.ac.jp/ej/?action=pages_view_main&active_action=repository_view_main_item_detail&item_id=64473&item_no=1&page_id=13&block_id=8
https://ipsj.ixsq.nii.ac.jp/ej/?action=pages_view_main&active_action=repository_view_main_item_detail&item_id=64181&item_no=1&page_id=13&block_id=8

また、スクラムについては2004年にはじめて、情報処理学会の研究報告が上がっています。
https://ipsj.ixsq.nii.ac.jp/ej/?action=pages_view_main&active_action=repository_view_main_item_detail&item_id=21293&item_no=1&page_id=13&block_id=8


また当時の雑誌媒体についても2誌で情報を調べてみたところこれを裏付ける内容で、情報が出てきたのも同様の順でした。
...
先ほどの契機となった話のあと、Jeff Sutherlandはこれらを整理・構築し2011年に、「スクラムガイド」をまとめ上げます。
...
XPについては、まず原情報に振れるのであればXP本を参照してもらうのが良いでしょう。
現在の最新のXP本は、オーム社から第２版が出ています。
...
PDFは無償DLできるのでぜひ読んでみよう。 https://www.ipa.go.jp/archive/publish/qv6pgp00000010et-att/000027628.pdf
