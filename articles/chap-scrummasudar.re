...
2日間から4日間の研修を受け、その後ペーパーテストに合格することで、担当トレーナーから認定されます。


2024年7月時点で、日本でCSMの研修を開催している企業は、株式会社Odd-e Japan、株式会社アトラクタ、アギレルゴコンサルティング株式会社、アジャイルビジネスインスティテュート株式会社、TIS株式会社の5社です。
...
研修を受けた後、担当トレーナーからペーパーテストを受ける資格があると認められると、ペーパーテストに関する案内が送られてきます。ペーパーテストはオンラインで実施され、テストに合格すると認定資格を得ることができます。
