...
日本語への対応が他の2資格と比較すると遅れており、テストは英語のみです。


テスト受験のための研修は不要ではありますが、Professional Scrum Master™ Iへの試験料込の研修が実施されています。
2024年7月時点で、日本では、株式会社ITプレナーズジャパン・アジアパシフィックのみが研修を提供しています。


認定取得のための費用は、テストのみであれば、2万円程度です。研修に参加する場合は、20万円程度になります。
