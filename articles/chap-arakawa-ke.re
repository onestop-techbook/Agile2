...
もっというと私自身がすべてを理論立てて解説できるとは言い切れない部分もあります。
...
仲間の回答は「後者」とのことでした。
やっぱりそうかと思った私は、夏頃の新人研修で使った資料を使いながら解説を開始しました。
...
そして仮定の話として、この完成品はとてもよく出来ていて、ビジネス的に大成功（売上がとても良い）といえるクオリティのモノであるとイメージしてください。
...
〓図4.1〓の下部、すなわちアジャイルなプロセスの図は便宜上5つの輪っか（イテレーション≒繰り返し）でバージョン1.0が完成していますが、現実的にはもっとたくさんのイテレーションが必要となるでしょう（この図を見せたときに非エンジニア仲間から「あ、そっか！」という反応をいただいたのは気持ちが良かった）。
...
アジャイルな開発を目指すには「アジャイルマニフェスト」とそこで謳われている価値や主義に基づいた12の原則を関係者全員が理解し実践する@<strong>{「状態」}になることを目指すという組織としての覚悟が必要となってきます。
...
そのようなモノは当初の企画通りに集中して作ってしまったほうが、スピード、コスト、品質面でも成功の確度は高く、アジャイルが出る幕はありません。
