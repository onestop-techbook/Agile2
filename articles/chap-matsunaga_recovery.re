...
では、〓図7.1〓において、Investmentはどれで、Returnはどれでしょう。Returnというのはその活動の成果として得られる利益などを指すのですから、この図でいえば「Return」は一番右の「アウトカム」だけとなります。わかりますか。つまりみなさんが作っているソフトウェアシステムは、作って納入するだけで価値があるわけではなく、運用されて、なんらかの効果が得られて、はじめて「Return」、すなわち価値となり得るわけです。ソフトウェアシステムは、それ単体では「Investment」、つまり投資にすぎないということです。ええ～そんなあ～。
