...
そしてさらに、分母であるInvestmentは小さいほうがROIは大きくなるので、みなさんはなるべく仕事をしないほど良いということになりますね。やったぜ！
 
//image[image3][ROIの最大化][scale=1.0]

でも別の見方をすると、アウトプットをいくらたくさん生み出しても、それがアウトカムにつながらなければ何の意味もないどころかお金の無駄づかいだったということになりますね。価値がゼロのものをどれだけたくさん作ってもゼロはゼロです。逆にいうと、大きなアウトカムが得られるならアウトプットは小さくシンプルであるほうが良いということになります。
...
前項の解説によると、スプリントゴールさえ達成出来るならば、スプリントプランニングで作ると決めた機能が、決めた通りにすべて完成していなくても良いことになりますよね？「目的が達成出来るなら手段はひとつじゃないよね？」ということです。
...
例えば、「当初フリーワード検索で考えていたけど、よく考えたら選択肢は5つしかないから、これだったらチェックボックスかラジオボタンで良くね？」となります。たぶんそのほうが文字コードチェックとかも要らないので実装も簡単ですし、なおかつ必要なものを検索するという当初の価値はまったく失われていません。
...
極論すれば、アジャイルは「如何にして作らずにすませるか」の技術です。よく「アジャイルでは何をやるかよりも、何をやらないかのほうが大事」といったことがいわれます。やらなくて良いことはやらない、作らなくても良いものは作らない。いたずらに仕事の量を追うのではなく、その価値を見極めて本当に必要なことだけをやっていけば、ものごとはシンプルになる、ということです。そうしていかに少ないコードで大きな価値を出すか（つまりROI）を考えていくと、作業時間も短くすることができるかも知れません。アジャイル開発では、そうやってリカバリーを行うのです。まあもちろんそれだけとは限らないし、それがうまくいかない場合もあるのは否定しませんが。
