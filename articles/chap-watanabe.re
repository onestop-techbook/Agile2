...
そのあとは、スクラムマスターとして、自身が学んできたこと（独習アジャイルや、それを通じて解像度があがった本やコミュニティの情報など）をチームに共有し、スクラムマスターとしての一歩をふみ出しました。さらに、そのスクラムチーム立ち上げの経験をもとに、全社にアジャイルを推進する組織を立ち上げることもできました。そして、今ではアジャイルコーチとしてさまざまな社内外のチームを支援しています。
