...
ここまで読み進めてきて、「アジャイルの実例はわかった、情熱もある。ただ、実践の場がなくて……」。そんな方もいるかもしれません。
...
まずは準備です。自分が持っているタスクをひたすら洗い出しましょう。これは仕事のことのみでもよいのですが、プライベートなタスクも含めると、よりスクラムの効果を実感できると思います。自分の頭の中にあるすべてを外に出しましょう。目に見えるかたちにすることで、「透明性」が上がり、自分の状況を認知しやすくなります。
...
特別な事情がない限り、1週間を一区切りとして「スプリント」を回していくのがわかりやすいです。例えば、月曜始まり日曜終わりのような、くり返しやすいタイムボックスを設定しましょう。
...
このように、日々状況を「検査」し、必要なら計画を立て直し「適応」していきます。これが「デイリースクラム」です。個人的には、1日の計画を立てやすいので、朝に実施することをおすすめします。

==== 「スプリントレビュー」

そして、1週間のおわりに成果（作った資料やもの、ソフトウェア）をほかの人に見てもらいます。できればチームメンバーやマネージャからコメントをもらいましょう。得られたフィードバックから新たなタスクを「プロダクトバックログ」に追加したり、全体的な「プロダクトバックログ」の方針を再検討します。人に見てもらうのが難しい場合は、自己評価でも問題ないです。その場合は、できるだけ客観的に確認するようにしましょう。
...
ここまで、独習アジャイルの進め方について解説をしてきました。「なんだよ、そんなことか」と思う方もいるかもしれません。それもそのはず。ぼくの考えでは、スクラム（そしてしばしば比較対象に挙がるウォーターフォール開発）は、タスク管理の手法であるからです。
...
そのあとは、スクラムマスターとして、自身が学んできたこと（独習アジャイルや、それを通じて解像度が上がった本やコミュニティの情報など）をチームに共有し、スクラムマスターとしての一歩を踏み出しました。さらに、そのスクラムチーム立ち上げの経験をもとに、全社にアジャイルを推進する組織を立ち上げることもできました。そして、今ではアジャイルコーチとしてさまざまな社内外のチームを支援しています。
...
ソフトウェア開発者としてキャリアをスタート。よりよい仕事の進め方を模索する中でチーム作りの大切さに目覚め、スクラムの導入や全社的なアジャイル推進活動を経験し、現在はNRI bit Labs に所属。アジャイルの導入支援やコーチングを行っている。
チームの立ち上げや、軌道修正が得意。
