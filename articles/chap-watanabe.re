...
スクラムに関する用語には括弧をつけています。それぞれの用語の内容を知っているものとして説明しているため、もしわからない単語があれば「スクラムガイド」や初学者向けの本（「SCRUM BOOT CAMP THE BOOK[増補改訂版]スクラムチームではじめるアジャイル開発」（翔泳社、2020）や『アジャイル開発とスクラム 第2版 顧客・技術・経営をつなぐ協調的ソフトウェア開発マネジメント』（翔泳社,2021）がおすすめ）を参照してください。「スクラムガイド」は、インターネットで検索すれば、すぐにでてきます。
