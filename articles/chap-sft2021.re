...
なんとかならないものかと考え、アジャイル開発やテスト駆動開発などに興味を持ち独学で勉強し始めます。当時、「＠IT ITアーキテクト塾 テストファーストの実践」@<fn>{atit}でパネラーから紹介されていた書籍の1つがさきほどの「初めてのアジャイル開発」で、いろいろと疑問に思っていたことがスッキリしたことを覚えています。
