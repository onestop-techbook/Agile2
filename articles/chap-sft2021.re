...
IT古典良書を読み解くということで、Craig Larman（クレーグ・ラーマン）の『初めてのアジャイル開発 スクラム、XP、UP、Evoで学ぶ反復開発の進め方』（日経BP,2004,以下『初めてのアジャイル開発』）を紹介します。なぜか各章の最初に名言が表示されていて、冒頭の名言は第3章 アジャイルからの引用になります。本書は2004年9月発売です。
