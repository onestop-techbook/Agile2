...
なんとかならないものかと考え、アジャイル開発やテスト駆動開発などに興味を持ち独学で勉強し始めます。当時、「＠IT ITアーキテクト塾 テストファーストの実践」@<fn>{atit}でパネラーから紹介されていた書籍の1つがさきほどの「初めてのアジャイル開発」で、読んでみるといろいろと疑問に思っていたことがスッキリしたことを覚えています。
...
ここで学べることは、アジャイルをバズワードのように用いるといわゆる「なんちゃってアジャイル」となり、「話がちがうじゃないか」とまさに誇大広告@<fn>{kodai}になってしまい誰も幸せになれない結果になります。正しくアジャイルを用いることで誰しも幸せになれる可能性があがるということです。


今回はアジャイルの代表的な手法である「スクラム」に関する用語が出てきますので用語の意味を学んでおくとよりわかりやすいですが、知らなくても考え方は伝わるかと思います。
...
よく聞かれる質問に「じゃあ、アジャイルにはどんなメリットがあるの？」があります。これにどう答えるのがよいのでしょうか。「第5章 導入理由」にあるアジャイル導入理由の見出しから特に大事だというものを見ていきましょう。 
...
そして、もう1つタイムボックスの価値は人間の不思議な習性に関連するとのことです。それは@<strong>{人は期限を守れなかったことはよく覚えているが、内容が少しぐらい不足していても気にはしない}というものです。100％を要求するウォーターフォールと、優先順位が高い機能から作成し75％でも納期にリリースできるアジャイルを表しているようです。
...
　→　こちらは立ち上げではとても難しいです。マネージャーは解決策を提示して指示しないといけないと思いますし、メンバーは逆に指示を仰ぎがちになってしまいます。徐々にでもよいので自律的なチームを作っていきましょう。個人的に一番よくないことが、決めたスプリントバックログを必ず終えるために、スプリント内でスコープ調整などをせずにウォータフォールのように稼働をあげて対応してしまうことです。
...
　→　ほかにもプロダクトオーナーが複数存在したり、最終意思決定が出来なかったりといった問題も散見されます。個人的にはプロダクトオーナーの意識、熱量不足があるとうまく回らないことが多いようです。

@<strong>{・ドキュメントが不十分である}


　→　アジャイル開発はドキュメントを作らなくてよいという話を聞いた方も多いかと思います。しかしが、反文章主義ではなく、成果物として定義していないだけであり、価値があるのであれば作成するべきです。
...
//footnote[bakuya][「莫邪の剣も持ち手による」。武器はよくても使う人がダメだと効果が発揮できないという意味。「宝の持ち腐れ」ではしっくりこないのでよりよいことわざはないかなと探したところ、ぴったりのものを見つけた次第です。筆者も初めて使いました。]


結論としては「アジャイルで幸せになれるが、持ち手による」ということでしょう。


最後に、スクラムが成功する価値について、第7章 スクラムより、特に大事な箇所を引用します。なお、一部の用語をわかりやすいよう現代風にあらためています。
